######################################################################################################################################################################
#This code cleans up the files and combines the individual ones into one file, in the directory combined_files
######################################################################################################################################################################
...
#Create list with all file names that start with the beginning of the scenario
...
#Concatenate files that belong to one scenario into one file:
i = 0
